...
/** 加载配置 */
@PropertySource(value = { "classpath:config/ssh.properties", "claspath:config/thirdParty.properties",
		"classpath:config/email.properties", "claspath:i18n/messages*.properties" })
