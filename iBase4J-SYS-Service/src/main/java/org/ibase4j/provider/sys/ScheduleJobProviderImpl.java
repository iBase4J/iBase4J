 ...
 */
@DubboService(interfaceClass = ScheduleJobProvider.class)
public class ScheduleJobProviderImpl extends BaseProviderImpl<ScheduleJob> implements ScheduleJobProvider {
