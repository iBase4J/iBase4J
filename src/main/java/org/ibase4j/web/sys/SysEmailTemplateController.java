...
public class SysEmailTemplateController extends BaseController<SysEmailTemplate, SysEmailTemplateService> {
    ...
    public Object get(ModelMap modelMap, SysEmailTemplate param) {
    ...
    public Object update(ModelMap modelMap, SysEmailTemplate param) {
    ...
    public Object delete(ModelMap modelMap, SysEmailTemplate param) {
