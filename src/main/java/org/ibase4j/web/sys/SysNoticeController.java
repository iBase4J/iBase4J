...
public class SysNoticeController extends BaseController<SysNotice, SysNoticeService> {
    ...
    public Object get(ModelMap modelMap, SysNotice param) {
    ...
    public Object update(ModelMap modelMap, SysNotice param) {
    ...
    public Object delete(ModelMap modelMap, SysNotice param) {
