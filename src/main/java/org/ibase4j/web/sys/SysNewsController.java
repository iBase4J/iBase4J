...
public class SysNewsController extends BaseController<SysNews, SysNewsService> {
    ...
    public Object get(ModelMap modelMap, SysNews param) {
    ...
    public Object update(ModelMap modelMap, SysNews param) {
    ...
    public Object delete(ModelMap modelMap, SysNews param) {
